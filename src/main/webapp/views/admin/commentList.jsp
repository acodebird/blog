		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				<ul class='nav nav-stacked'>
					...
					<li class='active'><a href='${pageContext.request.contextPath }/views/admin/listOrder.jsp'> <i
	          ...
	          <div class='span12 box bordered-box orange-border' style='margin-bottom:0;'>
	              <div class='box-content box-no-padding'>
	                  <div class='responsive-table'>
	                      <div class='scrollable-area' id="tableArea">
	                          <table id="myDatatable" class='table table-bordered display' style='margin-bottom:0;'>
	                              <thead>
	                                  <tr>
...
<!--  自定义js-->
	...
	<script type='text/javascript' src='${pageContext.request.contextPath}/views/admin/js/commentList.js'></script>
