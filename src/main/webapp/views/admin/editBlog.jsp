	                      ...
	                      <br>
	                      		<table align="center" width="700px">
	                      				<tr>
	                      					<td>
	                      						...
	                      						<input type="text" id="title" name="title" value="${blog.title }" style="width:700px" maxlength="100" placeholder="请输入标题(最大支持100个字符)">
								...
								<table align="center" width="700px">
	                      				<tr>
	                      					<td>
	                      						<br>
	                      						<input id="cancel" type="button" class="btn btn-danger" value="取消">
	                      						<input id="save" type="button" class="btn btn-primary" value="存为草稿">
	                      						<input id="update" type="button" class="btn btn-success" value="更新">
	                      					<td>
	                      				</tr>
	                      		</table>
	                      </div>
...
<script type="text/javascript">
	...
	var keyWord = "${blog.keyWord}".split(",");
	var blogTypeId = "${blog.blogType.id}";
</script>
...
<!--  自定义js-->
	...
	<!-- 引入自定义js文件 -->
	<script type='text/javascript' src='${pageContext.request.contextPath}/views/admin/js/editBlog.js'></script>
