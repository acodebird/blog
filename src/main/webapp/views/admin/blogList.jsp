		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				<ul class='nav nav-stacked'>
					...
					<li class='active'><a href='${pageContext.request.contextPath }/admin/showBlogs'> <i
...
<!--  自定义js-->
	...
	<script type='text/javascript' src='${pageContext.request.contextPath}/views/admin/js/blogList.js'></script>
