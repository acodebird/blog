$(function(){
	...
	loadLatestArticles();
	//广播提示语滚动
	$(".slideTxtBox").slide({titCell: ".hd ul", mainCell: ".bd ul", autoPage: true, effect: "top", autoPlay: true});
	//初始化首页展示的博客
	showBlogs();
...
function splitBlogData(blog){
	...
	content += '<a href="/blog/views/article.jsp?typeId='+blog.blogType.id+'">'+blog.blogType.typename+'</a></span>';
