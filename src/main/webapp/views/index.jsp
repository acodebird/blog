  ...
  <div class="col-sm-9 col-md-9">
  	...
  	<div class="slider_main">
            <div class="slider">
                <div class="bd">
                    <ul>
                        <li><a href="#" target="_blank"><img src="${pageContext.servletContext.contextPath }/views/img/temp/banner1.jpg"></a></li>
                        <li><a href="#" target="_blank"><img src="${pageContext.servletContext.contextPath }/views/img/temp/banner8.png"></a></li>
                    </ul>
                </div>
                <ol class="hd cl dots">
                    <li>1</li>
		...
		<div class="art_content">
			<ul class="index_arc">
				<li class="index_arc_item">
					<a href="#" class="pic">
						<img class="lazyload" data-original="${pageContext.servletContext.contextPath }/views/temp/art.jpg" alt="应该选" />
					</a>
					<h4 class="title"><a href="${pageContext.servletContext.contextPath }/views/article_detail.jsp">个人博客应该选择什么样的域名和域名后缀</a></h4>
					<div class="date_hits">
						<span>老王</span>
						<span>2017-02-24</span>
						<span><a href="${pageContext.servletContext.contextPath }/views//article-lists/10.jsp">程序人生</a></span>
				...
				<li class="index_arc_item no_pic">
					<h4 class="title"><a href="${pageContext.servletContext.contextPath }/views//article/5.jsp">个人博客应该选择什么样的域名和域名后缀</a></h4>
					<div class="date_hits">
						<span>老王</span>
						<span>2个月前</span>
						<span><a href="${pageContext.servletContext.contextPath }/views//article-lists/10.jsp">建站</a></span>
						<p class="hits"><i class="Hui-iconfont" title="点击量">&#xe6c1;</i> 276 °</p>
				...
				<li class="index_arc_item">
	            <a href="${pageContext.servletContext.contextPath }/views//article/4" class="pic">
	                <img class="lazyload" data-original="${pageContext.servletContext.contextPath }/views/temp/art.jpg" alt="centos 6.5 nginx安装及配置" >
	            </a>
	        <h4 class="title"><a href="${pageContext.servletContext.contextPath }/views//article/4">centos 6.5 nginx安装及配置</a></h4>
	        <div class="date_hits">
	            <span>老王</span>
	            <span>2017-3-15</span>
	            <span>
	                <a href="${pageContext.servletContext.contextPath }/views//article?t=1">程序人生</a>
	            </span>
         ...
         <li class="index_arc_item">
					<a href="${pageContext.servletContext.contextPath }/views/#" class="pic">
						<img class="lazyload" data-original="${pageContext.servletContext.contextPath }/views/temp/art.jpg" alt="应该选" />
					</a>
					<h4 class="title"><a href="${pageContext.servletContext.contextPath }/views/article_detail.jsp">个人博客应该选择什么样的域名和域名后缀</a></h4>
					<div class="date_hits">
  ...
  <div class="col-sm-3 col-md-3">
  	...
  	<div class="bg-fff box-shadow radius mb-20">
		...
		<div class="bg-fff box-shadow radius mb-20">
			...
			<div class="tab-category-item">
				<img data-original="${pageContext.servletContext.contextPath }/views/temp/gg.jpg" class="img-responsive lazyload" alt="响应式图片">
			</div>
		</div>
		...
		<div class="bg-fff box-shadow radius mb-20">
            ...
            <div class="panel-body">
                <ul class="recent">
                    <div class="item"><img src="${pageContext.servletContext.contextPath }/views/img/40.jpg" alt=""></div>
                    <div class="item"><img src="${pageContext.servletContext.contextPath }/views/img/40.jpg" alt=""></div>
                    <div class="item"><img src="${pageContext.servletContext.contextPath }/views/img/40.jpg" alt=""></div>
                    <div class="item"><img src="${pageContext.servletContext.contextPath }/views/img/40.jpg" alt=""></div>
                    <div class="item"><img src="${pageContext.servletContext.contextPath }/views/img/40.jpg" alt=""></div>
