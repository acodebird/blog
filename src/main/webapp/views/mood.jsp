...
<link rel="stylesheet" type="text/css" href="${pageContext.servletContext.contextPath }/views/css/timeline.css" />
<!--[if lt IE 9]>
        ...
        <div class="container cl">
            ...
            <nav class="nav navbar-nav nav-collapse w_menu" role="navigation">
                <ul class="cl">
                    ...
                    <li class="active"> <a href="${pageContext.servletContext.contextPath }/views/mood.jsp" data-hover="公告">公告</a> </li>
                </ul>
            </nav>
...
<nav class="breadcrumb">
    <div class="container"><i class="Hui-iconfont">&#xe67f;</i> 
	    <a href="${pageContext.servletContext.contextPath }/views/index.jsp" class="c-primary">首页</a> <span class="c-gray en">&gt;</span> 
	    <span class="c-gray">碎言碎语</span>
    </div>
</nav>
        ...
        <div class="timeline">
					...
					<div class="cd-timeline-block">
					    <div class="cd-timeline-img cd-picture">
					        <img src="${pageContext.servletContext.contextPath }/views/css/timeline/cd-icon-location.svg" alt="position">
					    </div>
