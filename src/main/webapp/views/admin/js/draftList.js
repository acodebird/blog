$(function(){
	...
	$("#searchBtn").on("click",function(){
		...
		location.href="/blog/admin/showBlogs?search=true&state=0&publishYear="+publishYear+
...
function pageTurning(currentPage){
	...
	if(search!=null&&search=="true"){
		location.href="/blog/admin/showBlogs?search="+search+"&state=0&currentPage="+currentPage+"&publishYear="+publishYear+
		"&typeId="+typeId+"&keyWord="+keyWord;
	}else{
		location.href="/blog/admin/showBlogs?currentPage="+currentPage+"&state=0";
	}
}