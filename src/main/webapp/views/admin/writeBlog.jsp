...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/views/admin/css/writeBlog.css">
    <link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/views/plugin/tagEditor/jquery.tag-editor.css">
		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				<ul class='nav nav-stacked'>
					...
					<li class='active'><a href='${pageContext.request.contextPath }/views/admin/writeBlog.jsp'> <i
	                  ...
	                  <div class='responsive-table'>
	                      ...
	                      <br>
	                      		<table align="center" width="700px">
	                      				<tr>
	                      					<td>
	                      						<input type="text" id="title" name="title" style="width:700px" maxlength="100" placeholder="请输入标题(最大支持100个字符)">
	                      						<p class="error" id="titleSpan">博客title不能为空</p>
	                      					</td>
	                      				</tr>
	                      				<tr>
	                      					<td>
	                      						<select id="typeId">
	                      							...
	                      							<option value="31">spring</option>
	                      							<option value="32">springmvc</option>
	                      							<option value="33">hibernate</option> -->
	                      						</select>
	                      						 <p class="error" id="typeIdSpan">博客类别不能为空</p>
	                      					</td>
	                      				</tr>
	                      				<tr>
	                      					<td>
	                      						<div class="layui-input-block w500">
												     <textarea id="tag" name="name" class="layui-textarea tag"></textarea>
												</div>
	                      					</td>
	                      				</tr>
                   				</table>
	                      		<div id="editor" style="width:710px;margin:auto;">
								　<!-- 默认显示 -->
								   <p>欢迎使用 <b>wangEditor</b> 富文本编辑器写博客</p>
								</div>
								<table align="center" width="700px">
	                      				<tr>
	                      					<td>
	                      						<br>
	                      						<input id="reset" type="button" class="btn btn-danger" value="重置">
	                      						<input id="save" type="button" class="btn btn-primary" value="存为草稿">
	                      						<input id="publish" type="button" class="btn btn-success" value="发表">
	                      					<td>
	                      				</tr>
	                      		</table>
	                      </div>
...
<!--  自定义js-->
	...
	<!-- 引入wangeditor编辑器 -->
	<script type='text/javascript' src='${pageContext.request.contextPath}/views/plugin/wangEditor/release/wangEditor.js'></script>
	<script type='text/javascript' src='${pageContext.request.contextPath}/views/admin/js/writeBlog.js'></script>
	<!-- 引入tagEditor -->
	<script type='text/javascript' src='${pageContext.request.contextPath}/views/plugin/tagEditor/jquery.tag-editor.js'></script>
