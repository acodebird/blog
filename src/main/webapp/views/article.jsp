...
<nav class="breadcrumb">
    <div class="container">
        ...
        <span class="c-gray en">&gt;</span> <a href="${pageContext.servletContext.contextPath }/views/article.jsp" class="c-primary">学无止尽</a>
